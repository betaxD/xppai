...
If XPO input is detected, perform direct XPO intake immediately before analysis text.
...
- If this skill is running standalone and XPO input is detected, perform direct XPO intake before analysis.
- If an orchestrator states `XPO intake already completed for this request`, do not perform intake again.
