...
If the draft fix includes localized edits, abort and return:

`Review result: FAIL`
`Failed checks: LOC-1`
`Required corrections: Remove localized edits and propose non-localized alternative or escalation path.`
