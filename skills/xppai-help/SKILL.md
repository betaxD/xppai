...
| `xppai-report` | Generate standardized markdown reports (change report, session resume, technical report) |
| `xppai-review` | Final compliance gate for tags, localization protection, and AX 2009 output rules |
...
**Need a formal report artifact?** → `xppai-report`

**Need to verify compliance before final output?** → `xppai-review`
